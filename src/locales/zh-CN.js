export default {
  ...
  'menu.admin': '运营管理',
  'menu.admin.home': '运营首页',
  'menu.admin.equipment': '设备管理',
  'menu.admin.armyManage': '队伍管理',
  'menu.admin.permissions': '权限管理',
  'menu.admin.feedback': '用户反馈',
  'menu.admin.armyManage.add': '新建',
  'menu.admin.armyManage.edit': '编辑',
  'menu.admin.armyManage.look': '查看',
  'menu.home': '首页',
